...
def create_pruned_cartpole(env_id='custom_cartpole' ,render_mode=None):
...
def make_stacked_cartpole(env_id='custom_cartpole', n_envs=1, num_frames=4, render_mode=None):
    env_fn = lambda: create_pruned_cartpole(env_id=env_id, render_mode=render_mode)
